...
router.post("/", auth, sauceCtrl.createSauce); // création d'une nouvelle instance de notre modèle Sauce
// router.post("/:id/like",auth, sauceCtrl.moodSauce); // ajout de like et dislike
router.put("/:id", auth, sauceCtrl.modifySauce); // modification d'une sauce existante
